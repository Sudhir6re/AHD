	...
	public List<BrokenPeriodResponseModel> calculateEmployeeSalaryBasedofBasic(String sevaarthid,
		...
		for (int i = 0; i < allEdpList.size(); i++) {
			...
			if (allEdpList.get(i).getType() == 1) { // allowance
				 ...
				 * 14 % of basic+DA dcpsempcontribution= ((basic+sevenpcda) * 14) /
				 * CommonConstants.PAYBILLDETAILS.COMMONCODE_PERCENTAGE_100; //
				...
				// NPS Empr Allow
					...
					/*
					 * if (year >= 20 && month >= 8) { if (basic != 0) { npsEmprAllow += (double)
					 * (Math.round((basic + da + svnDA) * 14 /
					 * CommonConstants.PAYBILLDETAILS.COMMONCODE_PERCENTAGE_100)); brokenPeriodModel
					 * = allEdpList.get(i); }
					 * 
					 * } else { npsEmprAllow += (double) (Math.round((basic + da + svnDA) * 14 /
					 * CommonConstants.PAYBILLDETAILS.COMMONCODE_PERCENTAGE_100)); brokenPeriodModel
					 * = allEdpList.get(i);
					 * 
					 * }
				...
				// NPS Emp Contri
					...
					BrokenPeriodModel brokenPeriodModel = allEdpList.get(i);
					/*
					 * if (year >= 20 && month >= 8) { if (basic != 0) { npsEmpContri += (double)
					 * (Math.round((basic + da + svnDA) * 14 /
					 * CommonConstants.PAYBILLDETAILS.COMMONCODE_PERCENTAGE_100)); }
					 * 
					 * } else { npsEmpContri += (double) (Math.round((basic + da + svnDA) * 14 /
					 * CommonConstants.PAYBILLDETAILS.COMMONCODE_PERCENTAGE_100));
					 * 
					 * }
					 */
					 ...
					 * CommonConstants.PAYBILLDETAILS.COMMONCODE_PERCENTAGE_100)); }else {
					 * npsEmpContri = (double) (Math.round((basic + svnDA + DaArr) * 10 /
					 * CommonConstants.PAYBILLDETAILS.COMMONCODE_PERCENTAGE_100)); }
					 * 
					 * } else { npsEmpContri = (double) (Math.round((basic + svnDA + DaArr) * 14 /
					 * CommonConstants.PAYBILLDETAILS.COMMONCODE_PERCENTAGE_100)); }
					 */
					logger.info("NPS EMP Contri=" + String.valueOf(npsEmpContri));
					brokenPeriodModel.setDeptalldetValue(String.valueOf(npsEmpContri));
				...
				// NPS Employer Contri
					...
					BrokenPeriodModel brokenPeriodModel = allEdpList.get(i);
					/*
					 * if (year >= 20 && month >= 8) { if (basic != 0) { npsEmprContri += (double)
					 * (Math.round((basic + da + svnDA) * 14 /
					 * CommonConstants.PAYBILLDETAILS.COMMONCODE_PERCENTAGE_100)); }
					 * 
					 * } else { npsEmprContri += (double) (Math.round((basic + da + svnDA) * 14 /
					 * CommonConstants.PAYBILLDETAILS.COMMONCODE_PERCENTAGE_100));
					 * 
					 * }
					 */
					...
					/*
					 * if (mstEmployeeModel.getGiscatagory().equals(1)) { if (year == 2023 && month2
					 * >= 8 || year >= 2024 && month2 >= 1) { npsEmprContri = (double)
					 * (Math.round((basic + svnDA + DaArr) * 14 /
					 * CommonConstants.PAYBILLDETAILS.COMMONCODE_PERCENTAGE_100)); } else {
					 * npsEmprContri = (double) (Math.round((basic + svnDA + DaArr) * 10 /
					 * CommonConstants.PAYBILLDETAILS.COMMONCODE_PERCENTAGE_100)); }
					 * 
					 * } else { npsEmprContri = (double) (Math.round((basic + svnDA + DaArr) * 14 /
					 * CommonConstants.PAYBILLDETAILS.COMMONCODE_PERCENTAGE_100)); }
					 */
				...
				// DCPS regular recovery
					...
					BrokenPeriodModel brokenPeriodModel = allEdpList.get(i);
					if (payCommission == CommonConstants.PAYBILLDETAILS.COMMONCODE_PAYCOMMISSION_7PC) {
						dcpsReg = (double) (Math.round(
								(basic + svnDA) * 10 / CommonConstants.PAYBILLDETAILS.COMMONCODE_PERCENTAGE_100));
					} else if (payCommission == CommonConstants.PAYBILLDETAILS.COMMONCODE_PAYCOMMISSION_6PC) {
						dcpsReg = (double) (Math
								.round((basic + da) * 10 / CommonConstants.PAYBILLDETAILS.COMMONCODE_PERCENTAGE_100));
					} else {
						dcpsReg = 0d;
					}
				 ...
				 * brokenPeriodModel=allEdpList.get(i); if(payCommission ==
				 * CommonConstants.PAYBILLDETAILS.COMMONCODE_PAYCOMMISSION_7PC) {
				 * logger.info("svnpc1"); dcpsArr = (double) (Math.round((basic + svnDA) * 10 /
				 * CommonConstants.PAYBILLDETAILS.COMMONCODE_PERCENTAGE_100)); } else if
				 * (payCommission ==
				 * CommonConstants.PAYBILLDETAILS.COMMONCODE_PAYCOMMISSION_6PC) {
				 * logger.info("svnpc2"); dcpsArr = (double) (Math.round((basic + da) * 10 /
				 * CommonConstants.PAYBILLDETAILS.COMMONCODE_PERCENTAGE_100)); } else {
				 * logger.info("svnpc3"); dcpsArr = 0d; }
				 * 
				 * logger.info("dcpsArr="+dcpsArr); logger.info("basic="+basic) ;
				...
				{
					BrokenPeriodModel brokenPeriodModel = allEdpList.get(i);
					adjust_dcps_empr = (double) (Math
							.round((basic + svnDA) * 14 / CommonConstants.PAYBILLDETAILS.COMMONCODE_PERCENTAGE_100));
					// paybillGenerationTrnDetails
				 ...
				 * Contribution --> 14 % of basic+DA adjdcpsempcontr= ((basic+sevenpcda) * 14) /
				 * CommonConstants.PAYBILLDETAILS.COMMONCODE_PERCENTAGE_100; //
				 ...
				 * allEdpList.get(i).getDeptalldetNm() !=
				 * CommonConstants.PAYBILLDETAILS.COMMONCODE_VALUE_NULL) { BrokenPeriodModel
				 * brokenPeriodModel=allEdpList.get(i); dcpsDelay = Math.round((basic + da) * 10
				 * / CommonConstants.PAYBILLDETAILS.COMMONCODE_PERCENTAGE_100);
				 * brokenPeriodModel.setDeptalldetValue(String.valueOf(dcpsDelay));
				 * deducTyEdpList.add(brokenPeriodModel); dedRuleList.add(brokenPeriodModel); }
				 * else if
				 ...
				 * allEdpList.get(i).getDeptalldetNm() !=
				 * CommonConstants.PAYBILLDETAILS.COMMONCODE_VALUE_NULL) { BrokenPeriodModel
				 * brokenPeriodModel=allEdpList.get(i); dcpsPayArr = Math.round((basic + da) *
