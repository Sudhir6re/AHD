...
public class DisplayInnerReportServiceImpl implements DisplayInnerReportService{
    ...
    CommonHomeMethodsService commonHomeMethodsService;
	 ...
	 public Page<DisplayInnerReportModel> findPaginated(Pageable pageable,Long billNumber,String strddo) {
	        ...
	        Page<DisplayInnerReportModel> innerPage
	          = new PageImpl<DisplayInnerReportModel>(list, PageRequest.of(currentPage, pageSize), lstinnerreports.size());
			...
			for (Iterator iterator = deducAgEdpList.iterator(); iterator.hasNext();) {
				...
				try {
					...
					if(maplstdedectionagSum.get(object.getDeptalldetNm().toLowerCase().trim()) !=null){
						...
						DecimalFormat decimalFormat =new DecimalFormat(pattern);
						 Double amt = Double.valueOf(decimalFormat.format(amount));
						maplstdedectionagSum.put(object.getDeptalldetNm().toLowerCase().trim(), amt.doubleValue());
					}else {
					...
					try {
						...
						if(allname.equals("FA")) {
							...
							if(map.get(object.getDeptalldetNm().toLowerCase().trim()).toString()!=null) {
								Double amount = Double.parseDouble(map.get(object.getDeptalldetNm().toLowerCase().trim()).toString());
//								Double amount = maplstdeducotherSum.get(object.getDeptalldetNm().toLowerCase().trim()) + Double.parseDouble(map.get(object.getDeptalldetNm().toLowerCase().trim()).toString());
								if(amount >0d) {
									lstfaLoan=displayInnerReportRepo.getfaLoanDtls(map.get("sevaarth_id").toString(),billNumber);
								}
							}
									...
									maplstdeducotherSum.put(object.getDeptalldetNm().toLowerCase().trim(),amount);
											if(maplstdeducotherSum.get(object.getDeptalldetNm().toLowerCase().trim()) !=null){
												...
												DecimalFormat decimalFormat =new DecimalFormat(pattern);
												 Double amt = Double.valueOf(decimalFormat.format(amount));
												 fasum=fasum+amt;
												maplstdeducotherSum.put(object.getDeptalldetNm().toLowerCase().trim(), fasum.doubleValue());
											}else {
...
//								Double amount = maplstdeducotherSum.get(object.getDeptalldetNm().toLowerCase().trim()) + Double.parseDouble(map.get(object.getDeptalldetNm().toLowerCase().trim()).toString());
								if(amount >0d) 
								 lstvaLoan=displayInnerReportRepo.getvaLoanDtls(map.get("sevaarth_id").toString(),billNumber);
							}
							Double amount=0d;
								if(lstvaLoan!=null) {
									row.add(lstvaLoan);
								...
								if(maplstdeducotherSum.get(object.getDeptalldetNm().toLowerCase().trim()) !=null){
									...
									DecimalFormat decimalFormat =new DecimalFormat(pattern);
									 Double amt = Double.valueOf(decimalFormat.format(amount));
									 vasum=vasum+amt;
									maplstdeducotherSum.put(object.getDeptalldetNm().toLowerCase().trim(), vasum.doubleValue());
								}else {
									maplstdeducotherSum.put(object.getDeptalldetNm().toLowerCase().trim(),  Double.parseDouble(map.get(object.getDeptalldetNm().toLowerCase().trim()).toString()));
								}
							}else {
...
//								Double amount = maplstdeducotherSum.get(object.getDeptalldetNm().toLowerCase().trim()) + Double.parseDouble(map.get(object.getDeptalldetNm().toLowerCase().trim()).toString());
								if(amount >0d) 
								 lstcaLoan=displayInnerReportRepo.getcaLoanDtls(map.get("sevaarth_id").toString(),billNumber);
							}
							Double amount=0d;
								if(lstcaLoan!=null) {
									row.add(lstcaLoan);
								...
								if(maplstdeducotherSum.get(object.getDeptalldetNm().toLowerCase().trim()) !=null){
									...
									DecimalFormat decimalFormat =new DecimalFormat(pattern);
									 Double amt = Double.valueOf(decimalFormat.format(amount));
									 casum=casum+amt;
									maplstdeducotherSum.put(object.getDeptalldetNm().toLowerCase().trim(), casum.doubleValue());
								}else {
									maplstdeducotherSum.put(object.getDeptalldetNm().toLowerCase().trim(),  Double.parseDouble(map.get(object.getDeptalldetNm().toLowerCase().trim()).toString()));
								}
							}else {
...
//								Double amount = maplstdeducotherSum.get(object.getDeptalldetNm().toLowerCase().trim()) + Double.parseDouble(map.get(object.getDeptalldetNm().toLowerCase().trim()).toString());
								if(amount >0d) 
								 lsthbaLoan=displayInnerReportRepo.gethbaLoanDtls(map.get("sevaarth_id").toString(),billNumber);
							}
							...
							Double amount=0d;
								...
								if(maplstdeducotherSum.get(object.getDeptalldetNm().toLowerCase().trim()) !=null){
									...
									DecimalFormat decimalFormat =new DecimalFormat(pattern);
									 Double amt = Double.valueOf(decimalFormat.format(amount));
									 hbasum=hbasum+amt;
									maplstdeducotherSum.put(object.getDeptalldetNm().toLowerCase().trim(), hbasum.doubleValue());
								}else {
									maplstdeducotherSum.put(object.getDeptalldetNm().toLowerCase().trim(),  Double.parseDouble(map.get(object.getDeptalldetNm().toLowerCase().trim()).toString()));
								}
							}else {
...
//								Double amount = maplstdeducotherSum.get(object.getDeptalldetNm().toLowerCase().trim()) + Double.parseDouble(map.get(object.getDeptalldetNm().toLowerCase().trim()).toString());
								if(amount >0d) 
								 lsthbaLoan=displayInnerReportRepo.gethbaLoanIntsDtls(map.get("sevaarth_id").toString(),billNumber);
							}
							System.out.println("-------lsthbaLoan----"+lsthbaLoan);
							Double amount=0d;
								if(lsthbaLoan!=null) {
								...
								if(maplstdeducotherSum.get(object.getDeptalldetNm().toLowerCase().trim()) !=null){
									...
									maplstdeducotherSum.put(object.getDeptalldetNm().toLowerCase().trim(), hbaintamtsum.doubleValue());
								}else {
									maplstdeducotherSum.put(object.getDeptalldetNm().toLowerCase().trim(),  Double.parseDouble(map.get(object.getDeptalldetNm().toLowerCase().trim()).toString()));
								}
							}else {
...
//								Double amount = maplstdeducotherSum.get(object.getDeptalldetNm().toLowerCase().trim()) + Double.parseDouble(map.get(object.getDeptalldetNm().toLowerCase().trim()).toString());
								if(amount >0d) 
								 lsthbaLoan=displayInnerReportRepo.getexPayRecDtls(map.get("sevaarth_id").toString(),billNumber);
							}
							System.out.println("-------lsthbaLoan----"+lsthbaLoan);
							Double amount=0d;
								if(lsthbaLoan!=null) {
...
//								Double amount = maplstdeducotherSum.get(object.getDeptalldetNm().toLowerCase().trim()) + Double.parseDouble(map.get(object.getDeptalldetNm().toLowerCase().trim()).toString());
								if(amount >0d) 
									lstgpfLoan=displayInnerReportRepo.getgpfLoanDtls(map.get("sevaarth_id").toString(),billNumber);
							}
							Double amount=0d;
								if(lstgpfLoan!=null) {
									row.add(lstgpfLoan);
								...
								if(maplstdeducotherSum.get(object.getDeptalldetNm().toLowerCase().trim()) !=null){
									...
									DecimalFormat decimalFormat =new DecimalFormat(pattern);
									 Double amt = Double.valueOf(decimalFormat.format(amount));
									 gpasum=gpasum+amt;
									maplstdeducotherSum.put(object.getDeptalldetNm().toLowerCase().trim(), gpasum.doubleValue());
								}else {
									maplstdeducotherSum.put(object.getDeptalldetNm().toLowerCase().trim(),  Double.parseDouble(map.get(object.getDeptalldetNm().toLowerCase().trim()).toString()));
								}
							}else {
...
//								Double amount = maplstdeducotherSum.get(object.getDeptalldetNm().toLowerCase().trim()) + Double.parseDouble(map.get(object.getDeptalldetNm().toLowerCase().trim()).toString());
								if(amount >0d) 
									lstgpfLoanII=displayInnerReportRepo.getgpfIILoanDtls(map.get("sevaarth_id").toString(),billNumber);
							}
							Double amount=0d;
								...
								if(maplstdeducotherSum.get(object.getDeptalldetNm().toLowerCase().trim()) !=null){
									...
									maplstdeducotherSum.put(object.getDeptalldetNm().toLowerCase().trim(), gpasumII.doubleValue());
								}else {
									maplstdeducotherSum.put(object.getDeptalldetNm().toLowerCase().trim(),  Double.parseDouble(map.get(object.getDeptalldetNm().toLowerCase().trim()).toString()));
								}
							}else {
...
//								Double amount = maplstdeducotherSum.get(object.getDeptalldetNm().toLowerCase().trim()) + Double.parseDouble(map.get(object.getDeptalldetNm().toLowerCase().trim()).toString());
								if(amount >0d) 
									lstpayfixdiffLoan=displayInnerReportRepo.getPayFixDiffLoanDtls(map.get("sevaarth_id").toString(),billNumber);
							}
							Double amount=0d;
								...
								if(maplstdeducotherSum.get(object.getDeptalldetNm().toLowerCase().trim()) !=null){
									...
									maplstdeducotherSum.put(object.getDeptalldetNm().toLowerCase().trim(), payfixsum.doubleValue());
								}else {
									maplstdeducotherSum.put(object.getDeptalldetNm().toLowerCase().trim(),  Double.parseDouble(map.get(object.getDeptalldetNm().toLowerCase().trim()).toString()));
								}
							}else {
						...
						} else if(!allname.equals("FA") ||!allname.equals("OTHER_VEH_ADV")||!allname.equals("COMP_ADV")||!allname.equals("HBA_HOUSE")
								||!allname.equals("GPF_Advance")||!allname.equals("OTHER_DEDUCTION")||!allname.equals("HBA_HOUSE_INT")
								||!allname.equals("OTHER_REC")||!allname.equals("OTHER_VEH_ADV_INT") ||!allname.equals("Pay_Fix_Diff")||!allname.equals("GPF_Advance")) {
							row.add(map.get(object.getDeptalldetNm().toLowerCase().trim()).toString());
							if(maplstdeducotherSum.get(object.getDeptalldetNm().toLowerCase().trim()) !=null){
								Double amount = maplstdeducotherSum.get(object.getDeptalldetNm().toLowerCase().trim()) + Double.parseDouble(map.get(object.getDeptalldetNm().toLowerCase().trim()).toString());
								String pattern="##.##";
								DecimalFormat decimalFormat =new DecimalFormat(pattern);
								 Double amt = Double.valueOf(decimalFormat.format(amount));
								maplstdeducotherSum.put(object.getDeptalldetNm().toLowerCase().trim(), amt.doubleValue());
							}else {
								maplstdeducotherSum.put(object.getDeptalldetNm().toLowerCase().trim(),  Double.parseDouble(map.get(object.getDeptalldetNm().toLowerCase().trim()).toString()));
							}
						}
						...
						if(!allname.equals("FA") ||!allname.equals("OTHER_VEH_ADV")||!allname.equals("COMP_ADV")||!allname.equals("HBA_HOUSE")
								||!allname.equals("GPF_Advance")||!allname.equals("OTHER_DEDUCTION")||!allname.equals("HBA_HOUSE_INT")
								||!allname.equals("OTHER_REC")||!allname.equals("OTHER_VEH_ADV_INT")||!allname.equals("Pay_Fix_Diff")||!allname.equals("GPF_Advance")) {
							row.add("0.00");
						}else {
				...
				for (Iterator iterator = deducTyEdpList.iterator(); iterator.hasNext();) {
					...
					try {
						...
						if(maplstdeductrsySum.get(object.getDeptalldetNm().toLowerCase().trim()) !=null){
								...
								maplstdeductrsySum.put(object.getDeptalldetNm().toLowerCase().trim(), amt.doubleValue());
						}else {
	...
	//DEDUCTIONS ADJUSTABLE BY TRY ended 
				...
				for (int i = 1; i <= 9; i++) {
					if(i<=empsize) {
						...
						if(map.get("gpf_adv_grp_abc")!=null || map.get("gpf_adv_grp_d")!=null || map.get("EXC_PAYRC")!=null) {
