...
public class NpsLegacyFileGenerationController extends BaseController {
	...
	public String genLegacyTxtFile(Model model, Locale locale, HttpSession session,
		...
		/*
		 * dcpsLegacyModel.setAction(""); dcpsLegacyModel.setLstDcpsLegacyModel(null);
		 * dcpsLegacyModel.setPeriod(""); ModelAndView modelAndView = new
		 * ModelAndView("/views/nps/legacy-file-generation");
		 * modelAndView.addObject("dcpsLegacyModel", new DcpsLegacyModel()); return
		 * modelAndView;
		 */
	}
