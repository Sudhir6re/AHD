...
//	
	...
	public String changeDetails(  @ModelAttribute("mstEmployeeEntity") EmpChangeDetailsModel empChangeDetailsModel,
		...
		List<MstEmployeeEntity> employeeConfigurationService = empChangeDetailsService.getEmployeeDetails(messages.getDdoCode(),
				locale.getLanguage());
...
//	@RequestMapping(value = "/editEmployeeConfiguration", method = { RequestMethod.GET, RequestMethod.POST })
//	public String editEmployeeConfiguration(@ModelAttribute("empChangeDetailsModel") EmpChangeDetailsModel empChangeDetailsModel,
//			Model model, Locale locale, HttpSession session) {
	@RequestMapping(value = "/changeEmpDtls/{empId}", method = { RequestMethod.GET, RequestMethod.POST })
	public String editEmployeeConfiguration(@ModelAttribute("empChangeDetailsModel") EmpChangeDetailsModel empChangeDetailsModel,
			Model model, Locale locale, HttpSession session,@PathVariable long empId) {
...
//		model.addAttribute("lstAccountMaintainby", mstEmployeeService.getAccountMaintainby());
		...
		if(empChangeDetailsModel.getEmployeeId()!=null) {
		 lstNmnDtlsEntity = mstEmployeeService
					.getNominees(empChangeDetailsModel.getEmployeeId().toString());
		}
		...
		if (empChangeDetailsModel.getPayCommissionCode() != null && !empChangeDetailsModel.getPayCommissionCode().equals(2500347))
	...
	public String saveEmployeeConfigurationChangeDetails(
			@ModelAttribute("empChangeDetailsModel") @Valid EmpChangeDetailsModel empChangeDetailsModel, BindingResult bindingResult,
	...
	public String ApprovOrRejectChngdtls(  @ModelAttribute("mstEmployeeDetailEntity") MstEmployeeDetailEntity mstEmployeeDetailEntity,
			Model model, Locale locale, HttpSession session) throws ParseException {
	...
	public String approveEmployeeConfiguration(@ModelAttribute("empChangeDetailsModel") EmpChangeDetailsModel empChangeDetailsModel,
			Model model, Locale locale, HttpSession session,@PathVariable long empId) {
...
//			model.addAttribute("lstAccountMaintainby", mstEmployeeService.getAccountMaintainby());
			...
			if(empChangeDetailsModel.getEmployeeId()!=null) {
			 lstNmnDtlsEntity = empChangeDetailsService
						.getNominees(empChangeDetailsModel.getEmployeeId().toString());
			}
			if(lstNmnDtlsEntity!=null)
			for (Iterator iterator = lstNmnDtlsEntity.iterator(); iterator.hasNext();) {
			...
			if(empChangeDetailsModel.getPayCommissionCode()!=null) {
				...
				if(empChangeDetailsModel.getPayCommissionCode().equals(2500347)    || empChangeDetailsModel.getPayCommissionCode()!=700016) {
					lstsixpayscalelevel = mstEmployeeService.findEmployeeConfigurationGetSixPayScale(2500341);
				}
				...
				if(empChangeDetailsModel.getPayCommissionCode().equals(2500347)  || empChangeDetailsModel.getPayCommissionCode()==700005)  {
					payscalelevel = mstEmployeeService.findEmployeeConfigurationGetpayscale(empChangeDetailsModel.getPayCommissionCode().intValue());
				}
			}
	...
	public String approveRejectChangeEmpDtls(@ModelAttribute("empChangeDetailsModel") @Valid EmpChangeDetailsModel empChangeDetailsModel,HttpSession session,
